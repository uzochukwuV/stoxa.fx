      ...
      <div className="camera_fakehover">
        ...
        <div className="camera_target">
          <div className="cameraCont">
            <div
              ...
              style={{visibility: "visible", display: "block", zIndex: 999}}
            >
              <Image
              alt=''
        ...
        <div className="camera_target_content">
          <div className="cameraContents">
            <div className="cameraContent cameracurrent" style={{display: "block"}}>
              <div className="w-full h-full flex justify-center items-center">
                <div className="flex items-center w-full justify-start">
                  <div
                    className="lg:ml-20 ml-10 slider-texts text-white w-2/3 overflow-hidden"
                  >
                    <div className="textheaders overflow-hidden">
                      <div
                        className="smaller-text animate__faster animate__animated animate__slideInLeft flex items-center font-medium lg:text-sm text-xs opacity-70 py-5 uppercase"
                      >
                        <svg
                      ...
                      <div
                        className={"larger-text text-white lg:text-5xl text-2xl sm:text-2xl md:text-3xl font-bold opacity-95 animate__fast animate__animated animate__fadeInLeft"}
                      >
                        Discover a World,
                    ...
                    <div
                      className="textcontexts my-5 opacity-90 animate__animated animate__fadeInLeft text-sm flex-wrap lg:text-base"
                    >
                      <p>
                    ...
                    <a className="flex" href="/auth"
                      ><div className="calltoactionBtn mt-10">
                        <div
                          className="cursor-pointer animate__animated animate__fadeInUp animate__delay-2s rounded-md px-3 flex justify-between/ items-center py-3 bg-white text-black font-bold text-sm lg:text-base md:text-base"
                        >
              ...
              <div className="w-full h-full flex justify-center items-center">
                <div className="flex items-center w-full justify-start">
                  ...
                  >
                    <div className="textheaders overflow-hidden">
                      <div
                        className="smaller-text animate__faster animate__animated animate__slideInLeft flex items-center font-medium text-xs opacity-70 py-5 uppercase"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          viewBox="0 0 20 20"
                      ...
                      <div
                        className="larger-text lg:text-5xl text-xl sm:text-2xl md:text-3xl font-bold opacity-95 animate__fast animate__animated animate__fadeInLeft"
                      >
                        Continue Trading.
                    ...
                    >
                      <p>
                        Pick up your trading activities right where you<br
                          className="hidden md:block lg:block"
                        />left off. Our platform ensures a smooth experience.<br
                          className="hidden md:block lg:block"
                    ...
                    <a className="flex" href="/auth"
                      ><div className="calltoactionBtn text-center mt-10">
                        <div
                          className="cursor-pointer animate__animated animate__fadeInUp animate__delay-2s rounded-md w-auto px-3 flex justify-between/ items-center py-3 bg-white text-black font-bold text-sm lg:text-base md:text-base"
                        >
                  ...
                  >
                    ...
                    >
                      <p>
                        ...
                        <br className="hidden md:block lg:block" />
                        unlock the unlimited potential of investing. Start with
                        <br className="hidden md:block lg:block" />us today and
