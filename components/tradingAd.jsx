    ...
    <div id="Advantages" className="wcy-container w-full pt-20 px-5 md:px-10">
      <div className="inner-cont w-full md:ext-center">
        ...
        >
          ...
          You Need<span className="text-blue-500"> Choose Us??</span>
        </div>
        <div
          data-aos="fade-left"
      ...
      <div className="cardcontainer">
        ...
        >
          <div className="stepOne bg-[#111] py-6 px-3 rounded-xl">
            <div className="stepHead">
              <div className="small-text text-amber-500">
                <div
                  className="cont flex items-center uppercase font-semibold opacity-70 text-xs"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
          ...
          >
            <div className="stepHead">
              <div className="small-text text-blue-500">
                <div
                  className="cont flex items-center uppercase font-semibold opacity-70 text-xs"
                >
                  <svg
              ...
              >
                <p>
                  investment for
                  <span className="small-text text-blue-500">All</span>
                </p>
              </div>
            </div>
            <div className="stepBody">
