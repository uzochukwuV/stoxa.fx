          ...
          <div className="Navigation-Items">
            <div className="itemcontainer lg:flex hidden text-black text-sm">
              ...
              <a className="font-bold">
                <div className="text-xs  font-bold opacity-100 text-red-500  border-b-2 border-b-red-500 mx-2 -px-2 pb-1 cursor-pointer transition-opacity duration-500">
                  Getting Started
                </div>
              </a>
              <a>
          ...
          <div className="items-center hidden lg:flex">
            ...
            <a href="/auth">
              <div className="ctaButtons lg:flex justify-between text-sm font-bold hidden items-center">
                <div className="btn1 px-4 cursor-pointer flex py-3 bg-clip-tet text-transprent bg-green-600 b-[conic-gradient(at_top_right,_var(--tw-gradient-stops))] from-red-800 via-red-700 to-orange-500 rounded-xl">
