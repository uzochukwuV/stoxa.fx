...
function Main() {
  return (
    <div>
        <div
  className="fixed top-32 right-0 z-50 translate-x-[8.3rem] hover:translate-x-0 cursor-pointer transition-all"
>
  <div
    className="rounded-tl-full rounded-bl-full py-2 pl-2 pr-4 shadow-md w-48 bg-[#222] text-white"
  >
  ...
  >
    ...
    <div className="Navigation-Items">
      <div className="itemcontainer lg:flex hidden text-black text-sm">
        <a
          ><div
            className="text-xs text-white font-normal opacity0 mx-2 -px-2 pb-1 cursor-pointer transition-opacity duration-500 hover:opacity-100"
          >
            Home
          </div></a
        ><a className="font-bold"
          ><div
            className="text-xs  font-bold opacity-100 text-red-500  border-b-2 border-b-red-500 mx-2 -px-2 pb-1 cursor-pointer transition-opacity duration-500"
          >
            Getting Started
          </div></a
        ><a
    ...
    <div className="items-center hidden lg:flex">
      ...
      ><a href="/auth"
        ><div
          className="ctaButtons lg:flex justify-between text-sm font-bold hidden items-center"
        >
          <div
          ...
          >
            <p className="px-0.5 opacity-90 text-white">Create an account</p>
          </div>
        </div></a
      >
    </div>
