...
function AnimateHero({ children, props }) {
  var { duration, delay, x, y } = props;
  return (
    <motion.div
      className={"textSection lg:w-1/2 md:w-1/2 mt-10 z-20"}
...
function GettingStarted() {
  return (
    ...
    >
      <div className="absolute aos-init aos-animate" data-aos="fade-right">
      ...
      <div className="textSection lg:w-1/2 md:w-1/2 mt-10 z-20">
        ...
        >
          ...
          you&apos;ll be ready to start in no time. The fund is started in
        ...
        <a className="flex items-center" href="/auth">
          <div
            ...
            data-aos="fade-up"
          >
            <div className="px-5 py-4 text-blue-accent text-blue-500 hover:bg-white font-semibold text-sm items-center rounded-xl flex">
        ...
        >
            ...
            <div className="stepBody">
              <div className="body-cont text-sm px-3 text-gray-400">
                <p>
                  ...
                  fields regarding your personal information and trading
                  expertise to complete Client Area registration.
                </p>
              </div>
            </div>
          </div>
          <div className="stepOne my-2 py-6 px-3 rounded-xl bg-[#111]">
            <div className="stepHead">
              ...
              <div className="large-text capitalize text-lg py-2 font-semibold ml-3">
                <p>
                  make a <span className="text-blue-700">deposit</span>
                </p>
              </div>
            </div>
            <div className="stepBody">
        ...
        >
          <div className="stepOne py-6 px-3 rounded-xl bg-[#111]">
            <div className="stepHead">
              ...
              <div className="large-text capitalize text-lg py-2 font-semibold ml-3">
                <p>
                  <span className="text-blue-700">Trading</span> Interception
                </p>
              </div>
            </div>
            <div className="stepBody">
          ...
          <div className="stepOne my-2 py-6 px-3 rounded-xl bg-[#111]">
            <div className="stepHead">
              ...
              <div className="large-text capitalize text-lg py-2 font-semibold ml-3">
                <p>
                  Make <span className="text-blue-700">withdrawal</span>
                  request
                </p>
              </div>
            </div>
            <div className="stepBody">
              <div className="body-cont text-sm px-3 text-gray-400">
                <p>
                  ...
                  withdraw your funds. Funds are immediately sent to your wallet
                  address.
                </p>
              </div>
            </div>
