...
function Features() {
  return (
    ...
    className="wwd-container pt-5 md:flex flex flex-col max-w-[100vw] md:py-8 py-4 px-6 md:px-10 lg:flex-row md:bg-graient-to-r bg-graient-to-b from-red-50/80 via-white to-white bg-[#0a0a0a] text-white"
  >
    <div className="second-cont pt-8 md:pt-0 mb-1 md:w-2/3 mr-10">
      <div className="inner-cont">
        <div className="smallertex">
          <div
            className="inner-smaller-text flex items-center font-semibold my-2 uppercase text-sm aos-init"
            data-aos="fade-up"
          >
            <svg
        ...
        <div
          className="larger-text text-xl md:text-2xl lg:text-3xl font-bold aos-init"
          data-aos="fade-left"
        >
          Get
          <span
            className="bg-[conic-gradient(at_top_right,_var(--tw-gradient-stops))] from-red-700 via-red-600 to-orange-700 bg-clip-text text-transparent"
            >Exceptional</span
          >
          Services!!
        </div>
    ...
    <div className="first-cont md:flex md:w-full flex-grow">
      <div
        className="card-container1 md:mr-5 w-full aos-init"
        data-aos="fade-left"
        data-aos-delay="100"
      >
        <div className="card1">
          <div className="stepOne py-6 px-3 rounded-xl bg-[#111]">
            <div className="stepHead">
              <div className="small-text">
                <div
                  className="cont flex items-center uppercase font-semibold opaity-70 text-xs"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
              ...
              <div
                className="large-text capitalize text-lg py-2 font-semibold ml-3"
              >
                <p>
                  Safe &amp;
                  <span
            ...
            <div className="stepBody">
              <div className="body-cont text-sm px-3 text-gray-400">
                <p>
                  ...
                  found to be really profitable to make any sort of investment.
                </p>
              </div>
            </div>
          </div>
      ...
      <div
        className="card-container2 w-full aos-init"
        data-aos="fade-right"
        data-aos-delay="200"
      >
        <div className="card1 my-2 md:my-0">
          <div className="stepOne py-6 px-3 rounded-xl bg-[#111]">
            <div className="stepHead">
              <div className="small-text">
                <div
                  className="cont flex items-center uppercase font-semibold opacty-70 text-xs"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
