        ...
        <div className="inner-cont">
          ...
          >
            <p>
              ...
              care. From the moment you arrive, we create a warm and
            ...
            <div className="stepOne py-6 px-3 rounded-xl bg-[#111]">
              ...
              <div className="stepBody">
                <div className="body-cont text-sm px-3 text-gray-400">
                  <p>
                    This platform is built and maintained with maximum security
                    in order to retain the ability to keep the trust of it
                    &lsquo; s users.
                  </p>
                </div>
              </div>
          ...
          <div className="card1 my-2 md:my-0">
            <div className="stepOne py-6 px-3 rounded-xl bg-[#111]">
              ...
              <div className="stepBody">
                <div className="body-cont text-sm px-3 text-gray-400">
                  <p>
                    Each user &lsquo; s wallet is safe and secured, as all
                    asset, funds are stored in a secured offline storage system.
                  </p>
                </div>
              </div>
            </div>
