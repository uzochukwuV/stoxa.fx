      ...
      <div>
        <div class="pt-4 px-4">
          ...
          <div class="input-region">
            <div class="rounded-md mt-5 flex items-center px-3 capitalize w-full  border border-white/10 text-black/50">
              <input
          ...
          <div class="traders-region mt-6">
            <div class="grid grid-cols-1 w-full md:grid-cols-2 lg:grid-cols-3 gap-4">
              <div class=" w-full p-3 relative rounded-md border-2 text-black/50  borderborder-white/5 ">
                ...
                <div class="image-region overflow-hidden flex justify-center w-full">
                  <div class="img-container w-20 h-20 rounded-full overflow-hidden">
                    <Image
                      ...
                      class=""
                      srcset="
                    /assets/copy-7.jpg&amp;w=1080&amp 1x,
                    /assets/copy-7.jpg 2x
                  "
                      src="/assets/copy-7.jpg"
                ...
                <div class="key-items mt-2 flex gap-x-3 justify-center items-center text-black/50/80">
                  <div class="totalTrades flex items-center p-2 rounded-sm ">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 20 20"
                      fill="currentColor"
                ...
                <div class="other-deets grid grid-cols-2 gap-x-2 mt-2">
                  <div class="winrate flex items-center justify-between p-3 rounded-sm mt-2 bg-gray-300 text-black/50/70">
                  ...
                  <div class="winrate flex items-center justify-between p-3 rounded-sm mt-3 bg-gray-300 text-black/50/70">
                    <div class="flex items-center gap-x-2">
                ...
                <div class="btn flex justify-center mt-8">
                  <button class=" rounded-md px-4 py-3 text-sm font-bold bg-[conic-gradient(at_top_right,_var(--tw-gradient-stops))] from-blue-800 via-blue-500 to-blue-800 text-white">
                ...
                <div class="image-region overflow-hidden flex justify-center w-full">
                  <div class="img-container w-20 h-20 rounded-full overflow-hidden">
                    <Image
                      ...
                      class=""
                      srcset="
                    /assets/copy-14.jpg&amp;w=1080&amp 1x,
                    /assets/copy-14.jpg 2x
                  "
                      src="/assets/copy-14.jpg"
                      style={{color: "transparent"}}
                    />
                  </div>
                </div>
              ...
              <div class=" w-full p-3 relative rounded-md border-2 text-black/50  borderborder-white/5 ">
                ...
                <div class="image-region overflow-hidden flex justify-center w-full">
                  <div class="img-container w-20 h-20 rounded-full overflow-hidden">
                    <Image
                      ...
                      class=""
                      srcset="
                    /assets/copy-trader-2.jpg&amp;w=1080&amp 1x,
                    /assets/copy-trader-2.jpg 2x
                  "
                ...
                <div class="btn flex justify-center mt-8">
                  <button class=" px-4 py-3 text-sm font-bold bg-[conic-gradient(at_top_right,_var(--tw-gradient-stops))] from-blue-800 via-blue-500 to-blue-800 text-white">
                    Copy Trader Strategy
                  </button>
                </div>
              </div>
                ...
                <div class="image-region overflow-hidden flex justify-center w-full">
                  <div class="img-container w-20 h-20 rounded-full overflow-hidden">
                    <Image
                      ...
                      class=""
                      srcset="
                    /assets/copy-trader-3.jpg&amp;w=1080&amp 1x,
                    /assets/copy-trader-3.jpg 2x
                  "
                      src="/assets/copy-trader-3.jpg"
                      style={{color: "transparent"}}
                    />
                  </div>
                </div>
                ...
                <div class="image-region overflow-hidden flex justify-center w-full">
                  <div class="img-container w-20 h-20 rounded-full overflow-hidden">
                    <Image
                      ...
                      class=""
                      srcset="
                    /assets/copy-trader-4.jpg&amp;w=1080&amp 1x,
                    /assets/copy-trader-4.jpg 2x
                  "
                ...
                <div class="image-region overflow-hidden flex justify-center w-full">
                  <div class="img-container w-20 h-20 rounded-full overflow-hidden">
                    <Image
                      ...
                      class=""
                      srcset="
                    /assets/copy-trader-5.jpg&amp;w=1080&amp 1x,
                    /assets/copy-trader-5.jpg 2x
                  "
                      src="/assets/copy-trader-5.jpg"
                      style={{color: "transparent"}}
                    />
                  </div>
                </div>
                ...
                <div class="image-region overflow-hidden flex justify-center w-full">
                  <div class="img-container w-20 h-20 rounded-full overflow-hidden">
                    <Image
                      ...
                      class=""
                      srcset="
                    /assets/copy-6.jpg&amp;w=1080&amp 1x,
                    /assets/copy-6.jpg 2x
                  "
                      src="/assets/copy-6.jpg"
                      style={{color: "transparent"}}
                    />
                  </div>
                </div>
                ...
                <div class="image-region overflow-hidden flex justify-center w-full">
                  <div class="img-container w-20 h-20 rounded-full overflow-hidden">
                    <Image
                      ...
                      class=""
                      srcset="
                    /assets/copy-trader.jpg&amp;w=1080&amp 1x,
                    /assets/copy-trader.jpg 2x
                  "
                ...
                <div class="image-region overflow-hidden flex justify-center w-full">
                  <div class="img-container w-20 h-20 rounded-full overflow-hidden">
                    <Image
                      ...
                      class=""
                      srcset="
                    /assets/copy-13.jpg&amp;w=1080&amp 1x,
                    /assets/copy-13.jpg 2x
                  "
                      src="/assets/copy-13.jpg"
                      style={{color: "transparent"}}
                    />
                  </div>
                </div>
                ...
                <div class="image-region overflow-hidden flex justify-center w-full">
                  <div class="img-container w-20 h-20 rounded-full overflow-hidden">
                    <Image
                      ...
                      class=""
                      srcset="
                    /assets/copy-trader-1.jpg&amp;w=1080&amp 1x,
                    /assets/copy-trader-1.jpg 2x
                  "
                      src="/assets/copy-trader-1.jpg"
                      style={{color: "transparent"}}
                    />
                  </div>
                </div>
                ...
                <div class="image-region overflow-hidden flex justify-center w-full">
                  <div class="img-container w-20 h-20 rounded-full overflow-hidden">
                    <Image
                      ...
                      class=""
                      srcset="
                    /assets/copy-9.jpg&amp;w=1080&amp 1x,
                    /assets/copy-9.jpg 2x
                  "
                      src="/assets/copy-9.jpg"
                      style={{color: "transparent"}}
                    />
                  </div>
                </div>
                ...
                <div class="image-region overflow-hidden flex justify-center w-full">
                  <div class="img-container w-20 h-20 rounded-full overflow-hidden">
                    <Image
                      ...
                      class=""
                      srcset="
                    /assets/copy-10.jpg&amp;w=1080&amp 1x,
                    /assets/copy-10.jpg 2x
                  "
                      src="/assets/copy-10.jpg"
                      style={{color: "transparent"}}
                    />
                  </div>
                </div>
                ...
                <div class="image-region overflow-hidden flex justify-center w-full">
                  <div class="img-container w-20 h-20 rounded-full overflow-hidden">
                    <Image
                      ...
                      class=""
                      srcset="
                    /assets/copy-11.jpg&amp;w=1080&amp 1x,
                    /assets/copy-11.jpg 2x
                  "
                ...
                <div class="image-region overflow-hidden flex justify-center w-full">
                  <div class="img-container w-20 h-20 rounded-full overflow-hidden">
                    <Image
                      ...
                      class=""
                      srcset="
                    /assets/copy-12.jpg&amp;w=1080&amp 1x,
                    /assets/copy-12.jpg 2x
                  "
                      src="/assets/copy-12.jpg"
                      style={{color: "transparent"}}
                    />
                  </div>
                </div>
