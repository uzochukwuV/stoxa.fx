  ...
  return (
    <div className="p-4">
      <div className="shadow-[rgba(50,_50,_105,_0.15)_0px_2px_5px_0px,_rgba(0,_0,_0,_0.05)_0px_1px_1px_0px] rounded-xl p-5">
        ...
        <div className="message border border-blue-600 text-blue-600 rounded-md p-3 mt-4 text-sm bg-blue-50">
          <article>
            <b className="font-bold">Note:</b> You're not able to change your
            password until after 15 days of account creation. We already employ
            advanced security measures so your account is safe with us
          </article>
        </div>
      </div>
    </div>
