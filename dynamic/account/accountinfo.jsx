...
function AccountInfo() {
  return (
    <div className="p-4">
  <div
    className="card-container bg-color-change[#111] border-white/10 text-color-change /90 p-4 border grid grid-cols-1 lg:grid-cols-2 gap-2 rounded-xl"
  >
    <div
      className="accoutsect bg-color-change[#222] p-3 rounded-md border-white/10 border font-medium my-2"
    >
      ...
      <div className="name-cont flex items-center text-sm py-1">
        ...
        <div className="userName ml-2 font-bold">victor Ezealor</div>
      </div>
      <div className="email-cont my-4 flex items-center text-sm py-1">
        ...
        <div className="email mx-2">vic.ezealor@gmail.com</div>
      </div>
      <div className="inventment-cont my-4 flex items-center text-sm py-1">
        ...
        <div className="plan font-bold mx-2 capitalize">$0</div>
      </div>
      <div className="email-cont my-4 flex items-center text-sm py-1">
        <div className="flex items-center">
          <svg
    ...
    <div className="settingGuage col-span2 text-sm pr-3">
      <div
        className="switch-container flex items-center my-4 justify-between w-full"
      >
      ...
      <div
        className="slider-container flex items-center my-8 justify-between w-full p-3 border border-white/10 bg-color-change[#222] rounded-md"
      >
